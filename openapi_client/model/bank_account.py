...
class BankAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_holder_name, account_number, routing_number, billing_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_holder_name, account_number, routing_number, billing_address, *args, **kwargs):  # noqa: E501
        """BankAccount - a model defined in OpenAPI
