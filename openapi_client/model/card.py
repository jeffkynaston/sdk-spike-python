...
class Card(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_holder_name, account_number, cvv, expiration_month, expiration_year, billing_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_holder_name, account_number, cvv, expiration_month, expiration_year, billing_address, *args, **kwargs):  # noqa: E501
        """Card - a model defined in OpenAPI
